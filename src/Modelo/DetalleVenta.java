...
public class DetalleVenta {
 ...
 this.preciounitario=0.0;
  ...
  this.estado=0;
    ...
    public DetalleVenta(int idDetalleVenta, int idCabeceraVenta, int idProducto, String nombre, int cantidad, double preciounitario, double subTotal, double descuento, double igv, double totalPagar, double estado) {
