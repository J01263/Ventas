...
public class Login extends javax.swing.JFrame {
    ...
    public void validar() {
        ...
        if (!"".equals(correo) || !"".equals(pass)) {
            ...
            if (lg.getCorreo() != null && lg.getPass() != null) {
                ...
                JOptionPane.showMessageDialog(null, "El correo o la clave ingresada son incorrectos.");
            }
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 290, 400));

        jPanel1.setBackground(new java.awt.Color(153, 153, 153));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/logo01.png"))); // NOI18N
        jLabel7.setText(" ");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Equipos de Cómputo y Accesorios");
